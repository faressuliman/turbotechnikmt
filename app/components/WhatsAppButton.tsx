...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 left-4 z-[9999] flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-green-500 to-green-600 shadow-lg transition-all hover:shadow-xl sm:bottom-6 sm:left-6 sm:h-14 sm:w-14 cursor-pointer"
      initial={{ scale: 0 }}
      animate={{ scale: 1 }}
